...
## Project Structure
    ...
    ├── test_story_studio_d_49545  # Django project configurations
...
1. Clone this repo and `cd test_story_studio_d_49545`
...
2. Clone this repo and `cd test_story_studio_d_49545`
